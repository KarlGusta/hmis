                    ...
                    <div class="card card-custom">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="card-actions">
                                <a href="schedule.php" class="btn button-custom">
                                ...
                                <table class="table table-vcenter card-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="view.php?id=<?= $apt['id'] ?>" class="btn btn-sm button-custom-white-sm mr-2">
                                                        View
                                                    </a>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if (canModifyAppointment($apt)): ?>
                                                    <a href="edit.php?id=<?= $apt['id'] ?>" class="btn btn-sm button-custom-white-sm mr-2">
                                                        Edit
                                                    </a>
                                                    <button type="button" class="btn btn-sm button-custom-white-sm"
